...
if __name__ == '__main__':
    ...
    # CHAT TEST
    chat_without_history = openai_manager.chat("Hey ChatGPT what is 2 + 3? But tell it to me as Yoda")

    # CHAT WITH HISTORY TEST
    FIRST_SYSTEM_MESSAGE = {"role": "system", "content": "From now on, you have a heavy Lisp."}
