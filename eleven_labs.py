...
load_dotenv()
ai_voice_name = 'Alex - Young American Male'
...
class ElevenLabsManager:
    ...
    def text_to_audio(self, input_text, voice=ai_voice_name, save_as_wave=True, subdirectory=""):
    ...
    def text_to_audio_played(self, input_text, voice=ai_voice_name):
        audio = generate(
          text=input_text,
          voice=voice,
          model="eleven_monolingual_v1"
    ...
    def text_to_audio_streamed(self, input_text, voice=ai_voice_name):
...
if __name__ == '__main__':
    ...
    elevenlabs_manager.text_to_audio_streamed("This is my streamed test audio, I'm so much cooler than played", ai_voice_name)
    time.sleep(2)
    elevenlabs_manager.text_to_audio_played("This is my played test audio, helo hello", ai_voice_name)
    time.sleep(2)
    file_path = elevenlabs_manager.text_to_audio("This is my saved test audio, please make me beautiful", ai_voice_name)
